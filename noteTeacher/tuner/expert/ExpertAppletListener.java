...
public class ExpertAppletListener implements MouseListener, MouseMotionListener {
	
	private ExpertAsistent asistent;
	
	public ExpertAppletListener(ExpertAsistent asistent) {
