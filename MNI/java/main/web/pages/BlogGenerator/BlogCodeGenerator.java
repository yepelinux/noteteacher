package pages.BlogGenerator;

import generadoresCodigo.GeneradorCodigoBlog;
...
public class BlogCodeGenerator extends BasePage {
	...
	private GeneradorCodigoBlog generador =  new GeneradorCodigoBlog();
	private String htmlText = "";
	private String title = "";
	private List<HashMap<String, Object>> photos;
	

	public BlogCodeGenerator(List<HashMap<String, Object>> photos) {
		...
		TextArea html = new TextArea("html", new PropertyModel(BlogCodeGenerator.this,"htmlText")){
			@Override
	...
	private class InputForm extends Form{
		...
		public InputForm(String id) {
			...
			add(new TextField("title", new PropertyModel(BlogCodeGenerator.this,"title")));
	...
	public void setGenerador(GeneradorCodigoBlog generador) {this.generador = generador;}
