...
public class LastSearch extends BasePage {
	...
	public LastSearch(Long operationType) {
		...
		Label error = new Label("error", new PropertyModel(LastSearch.this,"errorMesage")){
			@Override
	...
	private ListView createTable(String id) {
		...
		final ListView table = new ListView(id, new PropertyModel(LastSearch.this, "photos")){
